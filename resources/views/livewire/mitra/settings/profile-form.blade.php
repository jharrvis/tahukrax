<div>
    <div class="mb-8">
        ...
        <p class="text-slate-500 text-sm mt-1">Kelola informasi profil dan keamanan akun Anda.</p>
    </div>
                ...
                <form wire:submit="updateProfile">
                    <div class="space-y-4">
                        ...
                        <div class="border-t border-slate-100 dark:border-slate-800 pt-4 mt-6">
                            <h4 class="font-bold text-sm text-slate-500 mb-3 uppercase tracking-wider">Alamat Pengiriman Utama</h4>
                            
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Provinsi</label>
                                    <select wire:model.live="province_id" class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-brand-500 outline-none transition-all">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Kota/Kab</label>
                                    <select wire:model="city_id" class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-brand-500 outline-none transition-all" {{ empty($cities) ? 'disabled' : '' }}>
                             ...
                             <div class="mt-4">
                                ...
                                <input type="text" wire:model="postal_code" class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-brand-500 outline-none transition-all">
                            ...
                            <div class="mt-4">
                                ...
                                <textarea wire:model="address" rows="3" placeholder="Nama Jalan, No. Rumah, RT/RW, Kecamatan" class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-brand-500 outline-none transition-all"></textarea>
